...
package lib // Package lib 这个文件基于https://github.com/alphacep/vosk-api@0.3.50 修改，遵循Apache-2.0 license

// #cgo CPPFLAGS: -I${SRCDIR}
// #cgo !windows LDFLAGS: -L${SRCDIR} -lvosk -ldl -lpthread
// #cgo windows LDFLAGS: -L${SRCDIR} -lvosk -lpthread
// #include <stdlib.h>
// #include "vosk_api.h"
import "C"
import "unsafe"
